...
//var start_row = 306
var excel_file = 'WW\ 2016\ Overall\ Individual\ Adviser\ Report\ Data\ v2.7.xlsx'
var input_sheet = 'Individual Report';

var target_output_dir = './output'
var licensee_logo = 'NAB.png'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/NAB'

// report theme
var header_fill_style= '#f36f4c'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.40), (opts.page.height*0.185), {'scale': 0.15})
