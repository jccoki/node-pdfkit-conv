...
var licensee_logo = 'BT_select_2.png'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/BT Select'

// report theme
var header_fill_style= '#00aadb'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.425), (opts.page.height*0.2), {'scale': 0.5875})
