...
var licensee_logo = 'finwiz_2.jpg'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/Financial Wisdom'
var licensee_front_page = 'sunrise-77677_1280.jpg'

// report theme
var header_fill_style= '#6e4f9d'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.35), (opts.page.height*0.175), {'scale': 0.75})
