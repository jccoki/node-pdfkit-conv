...
//var start_row = 306
var excel_file = 'WW\ 2016\ Overall\ Individual\ Adviser\ Report\ Data\ v2.6.xlsx'
var input_sheet = 'Individual Report';

var target_output_dir = './output'
var licensee_logo = 'Westpac_Bank Logo.png'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/Westpac'
var licensee_front_page = 'sunrise-274257_1280.jpg'

// report theme
var header_fill_style= '#ce002e'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.33), (opts.page.height*0.175), {'scale': 0.325})
