...
var licensee_logo = 'St-George.png'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/St\ George'
var licensee_front_page = 'landscape-540115_1280.jpg'

// report theme
var header_fill_style= '#ffcd00'
var footer_fill_style= '#5a5a5a'
var table_font_color = '#fff'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.3450), (opts.page.height*0.18), {'scale': 0.60})
//    doc.image('resources/ww-frontpage-bg.png', (opts.page.width*0.175), (opts.page.height*0.25), {'scale': 0.45})
   ...
   //doc.flushPages()
    ...
    answer_lines = lines_func(doc_width, writable_width) + 1
...
//      question = worksheet[ XLSX.utils.encode_cell({'c': i, 'r': 1}) ].v.replace(' (Answer)', '')
      ...
      box_height = doc.currentLineHeight() * (lines + 3.5)
      doc.rect(curr_x, curr_y, totalWidth, box_height)
      doc.fillAndStroke('#dedede', '#000')
      doc.fillColor('#000')
