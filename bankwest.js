...
var licensee_logo = 'bw_logo2.png'
var licensee_images = 'resources/WW\ Licensees\ Charts\ v1.4/Bankwest FA'
var licensee_front_page = 'sunrise-274257_1280.jpg'

// report theme
var header_fill_style= '#f69123'
...
//    doc.path('M 0 '+ (opts.page.height*0.33) +' l 0 -' + header_band_height + ' l ' + opts.page.width + ' 0 l 0 ' + header_band_height + ' l -'+ opts.page.width +' 0').fillAndStroke("#c95109");
    ...
    // front page logos
    doc.image('resources/logos/' + licensee_logo, (opts.page.width*0.325), (opts.page.height*0.21), {'scale': 0.175})
